...
function atualizarPreview() {
  ...
  var propriedade =
    ...
    input_top_r.value +
    "px " +
    input_bottom_r.value +
    "px " +
    input_bottom_l.value +
    "px;";
...
function validarCampos() {
  var inputs = [input_top_l, input_top_r, input_bottom_r, input_bottom_l];
  for (valor of inputs) {
    if (valor.value.lenght === 0 || valor.value < 0) valor.value = 0;
    else if (valor.value > 300) valor.value = 300;
  }
}
